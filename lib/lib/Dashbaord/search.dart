    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return FractionallySizedBox(
          heightFactor: 0.85, // Reduced height to remove extra bottom space
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              "Filter",
                              style: Theme.of(context).textTheme.titleLarge, // Applied Theme
                            ),
                            IconButton(
                              icon: const Icon(Icons.close),
                              color: Theme.of(context).colorScheme.onSurface, // Match Theme
                        ...
                        // Age Range Slider
                        Text("Age Range", style: Theme.of(context).textTheme.bodyLarge),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('${_startAge.round()}', style: Theme.of(context).textTheme.bodyMedium),
                            Text('${_endAge.round()}', style: Theme.of(context).textTheme.bodyMedium),
                          ],
                        ),
                        const SizedBox(height: 16),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text("${_startHeight.toStringAsFixed(1)}'", style: Theme.of(context).textTheme.bodyMedium),
                            Text("${_endHeight.toStringAsFixed(1)}'", style: Theme.of(context).textTheme.bodyMedium),
                          ],
                        ),
                        const SizedBox(height: 16),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('${_startDistance.round()} Miles', style: Theme.of(context).textTheme.bodyMedium),
                            Text('${_endDistance.round()} Miles', style: Theme.of(context).textTheme.bodyMedium),
                          ],
                        ),
                        const SizedBox(height: 24),

                        // Apply Filter Button (Fixed Bottom Space)
                        Padding(
                          padding: const EdgeInsets.only(bottom: 8.0), // Reduced bottom space
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text(
                                "Apply Filter",
                                style: Theme.of(context).textTheme.labelLarge, // Applied Theme
                              ),
                            ),
                          ),
                        ),
